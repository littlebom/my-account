        ...
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center mb-6">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">ใบแจ้งหนี้ (Invoices)</h1>
                        <p className="text-sm text-gray-500">จัดการการขายและสร้างใบแจ้งหนี้</p>
                    </div>
                    <Link
                ...
                <div className="mb-6 relative">
                    ...
                    <input
                        type="text"
                        placeholder="ค้นหาใบแจ้งหนี้ (เลขที่, ลูกค้า)"
                ...
                <div className="bg-white shadow overflow-hidden sm:rounded-md">
                    {loading ? (
                        ...
                        <div className="p-12 text-center text-gray-500">ไม่พบใบแจ้งหนี้</div>
                    ) : (
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ลูกค้า</th>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {filteredInvoices.map((inv) => (
                                    <tr key={inv.id} className="hover:bg-gray-50 cursor-pointer" onClick={() => window.location.href = `/sales/invoices/${inv.id}`}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">
                                            {new Intl.NumberFormat('th-TH', { style: 'currency', currency: 'THB' }).format(Number(inv.totalAmount))}
                                        </td>
